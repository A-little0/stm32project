...
//MOTOR B
#define MB_ENA_OUT1_L HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,0)
#define MB_ENA_OUT1_H HAL_GPIO_WritePin(GPIOD,GPIO_PIN_1,1)
...
extern int watch_outerloopoutput;//目标角速度
extern int watch_interloopoutput;//目标速度
